...
const OngoingCampaignsCard = () => {
  return (
    ...
    <button type="button" className="btn btn-primary edit-button px-5">Edit</button>
    <button type="button" className="btn btn-primary delete-button px-5">Delete</button>
    </div>
</div>
  )
}
